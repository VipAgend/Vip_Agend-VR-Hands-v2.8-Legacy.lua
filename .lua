...
Title.Size = UDim2.new(1, 0, 0, 33) -- volle Breite, feste Höhe
Title.Position = UDim2.new(0, 0, 0, 0) -- oben im Panel
Title.AnchorPoint = Vector2.new(0, 0) -- oben links
Title.BackgroundTransparency = 1
Title.Text = "🌀 VR Props Control Panel"
Title.TextScaled = true
Title.TextWrapped = true
Title.TextXAlignment = Enum.TextXAlignment.Center -- horizontal zentriert
Title.TextYAlignment = Enum.TextYAlignment.Center -- vertikal zentriert
...
-- Spin/Gravity buttons row above axis controls
...
SpinButton.Size = UDim2.new(0.5, -8, 1, 0)
...
GravityButton.Size = UDim2.new(0.5, -8, 1, 0)
GravityButton.Position = UDim2.new(0.5, 8, 0, 0)
GravityButton.BackgroundColor3 = Color3.fromRGB(150, 70, 255)
GravityButton.TextColor3 = Color3.fromRGB(255,255,255)
GravityButton.Text = "Gravity Off"
GravityButton.Font = Enum.Font.GothamSemibold
GravityButton.TextScaled = true
GravityButton.Parent = TopButtonFrame
local GravityCorner = Instance.new("UICorner", GravityButton)
...
local function setButtonStates()
    ...
    GravityButton.BackgroundColor3 = AntiGravityEnabled and Color3.fromRGB(60, 220, 100) or Color3.fromRGB(150, 70, 255)
end
...
GravityButton.MouseButton1Click:Connect(function()
    ...
    GravityButton.Text = AntiGravityEnabled and "Gravity On" or "Gravity Off"
    setButtonStates()
    createExplosionEffect(Panel.Position, ScreenGui)
end)
...
GravityButton.MouseEnter:Connect(function()
    if not isActive then return end
    TweenService:Create(GravityButton, TweenInfo.new(0.18), {BackgroundColor3 = Color3.fromRGB(220, 60, 220)}):Play()
end)
GravityButton.MouseLeave:Connect(function()
    if not isActive then return end
    setButtonStates()
end)
